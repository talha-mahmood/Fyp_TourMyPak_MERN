...
<p className="text-white text-[24px] -mt-10 ml-2 font-extrabold backdrop-brightness-50 rounded-lg ">{description1}</p>
...
<p className="text-white text-[24px] -mt-10 ml-2 font-extrabold backdrop-brightness-50 ">{description2}</p>
<button className="flex h-12 justify-center items-center gap-1 self-stretch rounded-xl px-4 py-2 bg-secondarycolor text-white mt-4">{details}</button>

</div>
<div>
<img src={i3} alt='travel img' className="w-[270px] h-[350px] object-cover rounded-xl"/>
<p className="text-white text-[24px] -mt-10 ml-2 font-extrabold backdrop-brightness-50 ">{ description3}</p>
<button className="flex h-12 justify-center items-center gap-1 self-stretch rounded-xl px-4 py-2 bg-secondarycolor text-white mt-4">{details}</button>

</div>
<div>
<img src={i4} alt='travel img' className="w-[270px] h-[350px] object-cover rounded-xl"/>
<p className="text-white text-[24px] -mt-10 ml-2 font-extrabold backdrop-brightness-50">{  description4}</p>
<button className="flex h-12 justify-center items-center gap-1 self-stretch rounded-xl px-4 py-2 bg-secondarycolor text-white mt-4" >{details}</button>
